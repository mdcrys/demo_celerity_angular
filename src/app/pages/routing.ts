...
const Routing: Routes = [
...

  {
    path: 'contrato',
    loadChildren: () =>
      import('../modules/contrato/contrato.module').then(
        (m) => m.ContratoModule
      ),
  },

  {
    path: 'debito',
    loadChildren: () =>
      import('../modules/debito/debito.module').then((m) => m.DebitoModule),
  },

  {
    path: 'cancelacion',
    loadChildren: () =>
      import('../modules/cancelacion/cancelacion.module').then(
        (m) => m.CancelacionModule
      ),
  },
